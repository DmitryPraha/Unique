                            ...
                            <nav className="border-bottom border-block-end-dashed">
                                <div className="nav nav-tabs nav-justified" id="switcher-main-tab" role="tablist">
                                    <button className="nav-link active" id="switcher-home-tab" data-bs-toggle="tab"
                                            ...
                                            type="button" role="tab" aria-controls="switcher-home"
                                ...
                                <div className="tab-pane fade border-0" id="switcher-profile" role="tabpanel"
                                    ...
                                    <div>
                                        <div className="theme-colors">
                                            ...
                                            <div className="px-4 pb-3 text-muted fs-11">Note:If you want to change color
                                                Menu
                                        ...
                                        <div className="theme-colors">
                                            ...
                                            <div className="d-flex flex-wrap align-items-center switcher-style">
                                                <div className="form-check switch-select me-3">
                                                    <input className="form-check-input color-input color-primary-1"
                                                           type="radio"
                                                           name="theme-primary" id="switcher-primary"/>
                                                </div>
                                                <div className="form-check switch-select me-3">
                                                    <input className="form-check-input color-input color-primary-2"
                                                           type="radio"
                                                           name="theme-primary" id="switcher-primary1"/>
                                                </div>
                                                <div className="form-check switch-select me-3">
                                                    <input className="form-check-input color-input color-primary-3"
                                                           type="radio"
                                                           name="theme-primary"
                                                           id="switcher-primary2"/>
                                                </div>
                                                <div className="form-check switch-select me-3">
                                                    <input className="form-check-input color-input color-primary-4"
                                                           type="radio"
                                                           name="theme-primary"
                                                           id="switcher-primary3"/>
                                                </div>
                                                <div className="form-check switch-select me-3">
                                                    <input className="form-check-input color-input color-primary-5"
                                                           type="radio"
                                                           name="theme-primary"
                    ...
                    <div className="page">
                                    ...
                                    <span className="avatar avatar-xl avatar-rounded bg-warning-transparent">
                                        <i className="ri-shopping-cart-2-line fs-2"></i>
                                                    ...
                                                    <a href="" className="btn btn-primary btn-wave btn-sm m-1"
                                                       data-abc="true">continue shopping <i
                                                        className="bi bi-arrow-right ms-1"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                <p className="mb-0 fw-semibold"><a href="">Order
                                                                    Placed <span
                                                                        className="text-warning">ID: #1116773</span></a>
                                                                </p>
                                                                <span
                                                    ...
                                                    className="ti ti-clock fs-18"></i></span>
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                <p className="mb-0 fw-semibold"><a href="">Order
                                                                    Delayed <span
                                                                        className="text-success">ID: 7731116</span></a>
                                                                </p>
                                                                <span
                                    ...
                                    <div className="header-element">
                                        ...
                                        <ul className="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                                            ...
                                            <li><a className="dropdown-item d-flex" href="mail-settings.html"><i
                                                className="ti ti-adjustments-horizontal fs-18 me-2 op-7"></i>Settings</a>
                                            </li>
                                            <li><a className="dropdown-item d-flex border-block-end"
                        ...
                        <div className="main-content app-content">
                            <div className="container-fluid">
                                    ...
                                    <div className="ms-md-1 ms-0">
                                        <nav>
                                            <ol className="breadcrumb mb-0">
                                                <li className="breadcrumb-item"><a href="javascript:void(0);">В работе</a>
                                                </li>
                                            </ol>
                                        </nav>
                                    </div>
                                ...
                                <div className="row">
                                    <h6>По домену ozon.ru найдено:</h6>
                                    ...
                                    <h6>По домену cska.ru найдено:</h6>
                                    <div className="table-responsive">
                                        <table className="table text-nowrap table-bordered">
                                            <thead>
                                            <tr>
                                    ...
                                    <div className="modal-body">
                                        <div className="input-group">
                                            ...
                                            <ul className="dropdown-menu">
                                                ...
                                                <li><a className="dropdown-item" href="javascript:void(0);">Another
                                                    action</a>
                                                </li>
                                                ...
                                                <li><a className="dropdown-item" href="javascript:void(0);">Separated
                                                    link</a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div className="my-4">
                                            ...
                                            <div
                                                ...
                                                <a className="ms-auto lh-1" href="javascript:void(0);"
